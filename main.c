...
int main() {
    ...
    insert_new_edge(gp, 0, 1);
    insert_new_edge(gp, 0, 3);
    insert_new_edge(gp, 1, 2);
    insert_new_edge(gp, 3, 4);
    insert_new_edge(gp, 3, 5);
    insert_new_edge(gp, 4, 6);
    ...
    print_respost(bfs_in_graph(gp, 0));
